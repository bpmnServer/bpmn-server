...
const bpmnServer = new BPMNServer_1.BPMNServer(config);
...
};
{
    ...
    router.get('/invokeItem', awaitHandlerFactory((request, response) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        let item = yield bpmnServer.dataStore.findItem({ id: id });
        ...
        let result = yield bpmnServer.invoke({ id: id }, {}, {});
        let instance;
    ...
    router.post('/invokeItem', awaitHandlerFactory((request, response) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        console.log(data);
        let result = yield bpmnServer.invoke({ id: id }, {}, data);
        let instance;
        //instance= result.instance;
        response.redirect('/instanceDetails?id=' + result.instance.id);
        /*
...
function display(res, title, output, logs = [], items = []) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let engines = BPMNServer_1.BPMNServer.getLives();
...
function instanceDetails(response, instanceId) {
    return __awaiter(this, void 0, void 0, function* () {
        let instances = yield bpmnServer.findInstances({ id: instanceId });
        let items = yield bpmnServer.findItems({ instanceId: instanceId });
        let instance;
