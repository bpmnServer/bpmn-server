...
class DataStore {
    ...
    saveInstance(instance) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (instance.dbAction == 'add') {
                ...
                promises.push(this.db.update(this.dbConfiguration.db, Instance_collection, { id: instance.id }, { $set: { state: json, logs: instance.logs, endAt: instance.endAt } }));
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (i = 0; i < items.length; i++) {
                ...
                if (item.dbAction == 'add') {
                    ...
                    promises.push(this.db.update(this.dbConfiguration.db, Item_collection, { id: item.id }, { $set: { status: item.status, endAt: item.endAt } }));
                    updates++;
    ...
    findItems(query) {
        return __awaiter(this, void 0, void 0, function* () {
            var records = yield this.db.find(this.dbConfiguration.db, Item_collection, query);
            return records;
        });
    }
    deleteData(instanceId = null) {
        return __awaiter(this, void 0, void 0, function* () {
            if (instanceId) {
                yield this.db.remove(this.dbConfiguration.db, Item_collection, { instanceId: instanceId });
                yield this.db.remove(this.dbConfiguration.db, Instance_collection, { id: instanceId });
            }
            else {
                yield this.db.remove(this.dbConfiguration.db, Item_collection, {});
