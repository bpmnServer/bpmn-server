[bpmn-server](../README.md) / [Exports](../modules.md) / [elements/Events](../modules/elements_Events.md) / EndEvent

# Class: EndEvent

[elements/Events](../modules/elements_Events.md).EndEvent
...
- [constructor](elements_Events.EndEvent.md#constructor)

### Properties

- [assignee](elements_Events.EndEvent.md#assignee)
- [attachedTo](elements_Events.EndEvent.md#attachedto)
- [attachments](elements_Events.EndEvent.md#attachments)
- [behaviours](elements_Events.EndEvent.md#behaviours)
- [candidateGroups](elements_Events.EndEvent.md#candidategroups)
- [candidateUsers](elements_Events.EndEvent.md#candidateusers)
- [def](elements_Events.EndEvent.md#def)
- [id](elements_Events.EndEvent.md#id)
- [inbounds](elements_Events.EndEvent.md#inbounds)
- [initiator](elements_Events.EndEvent.md#initiator)
- [isFlow](elements_Events.EndEvent.md#isflow)
- [lane](elements_Events.EndEvent.md#lane)
- [messageId](elements_Events.EndEvent.md#messageid)
- [name](elements_Events.EndEvent.md#name)
- [outbounds](elements_Events.EndEvent.md#outbounds)
- [process](elements_Events.EndEvent.md#process)
- [scripts](elements_Events.EndEvent.md#scripts)
- [signalId](elements_Events.EndEvent.md#signalid)
- [subType](elements_Events.EndEvent.md#subtype)
- [type](elements_Events.EndEvent.md#type)

### Accessors

- [canBeInvoked](elements_Events.EndEvent.md#canbeinvoked)
- [isCatching](elements_Events.EndEvent.md#iscatching)
- [processId](elements_Events.EndEvent.md#processid)
- [requiresWait](elements_Events.EndEvent.md#requireswait)

### Methods

- [addBehaviour](elements_Events.EndEvent.md#addbehaviour)
- [cancelBoundaryEvents](elements_Events.EndEvent.md#cancelboundaryevents)
- [cancelEBG](elements_Events.EndEvent.md#cancelebg)
- [continue](elements_Events.EndEvent.md#continue)
- [describe](elements_Events.EndEvent.md#describe)
- [doEvent](elements_Events.EndEvent.md#doevent)
- [end](elements_Events.EndEvent.md#end)
- [enter](elements_Events.EndEvent.md#enter)
- [execute](elements_Events.EndEvent.md#execute)
- [getBehaviour](elements_Events.EndEvent.md#getbehaviour)
- [getInput](elements_Events.EndEvent.md#getinput)
- [getOutbounds](elements_Events.EndEvent.md#getoutbounds)
- [getOutput](elements_Events.EndEvent.md#getoutput)
- [hasBehaviour](elements_Events.EndEvent.md#hasbehaviour)
- [hasMessage](elements_Events.EndEvent.md#hasmessage)
- [hasSignal](elements_Events.EndEvent.md#hassignal)
- [hasTimer](elements_Events.EndEvent.md#hastimer)
- [init](elements_Events.EndEvent.md#init)
- [restored](elements_Events.EndEvent.md#restored)
- [resume](elements_Events.EndEvent.md#resume)
- [run](elements_Events.EndEvent.md#run)
- [setInput](elements_Events.EndEvent.md#setinput)
- [start](elements_Events.EndEvent.md#start)
- [startBoundaryEvents](elements_Events.EndEvent.md#startboundaryevents)
- [validate](elements_Events.EndEvent.md#validate)

## Constructors

### constructor

• **new EndEvent**(`id`, `process`, `type`, `def`): [`EndEvent`](elements_Events.EndEvent.md)
...
[src/elements/Events.ts:113](https://github.com/linonetwo/bpmn-server/blob/02da6f2/src/elements/Events.ts#L113)
...
[src/elements/Events.ts:114](https://github.com/linonetwo/bpmn-server/blob/02da6f2/src/elements/Events.ts#L114)
