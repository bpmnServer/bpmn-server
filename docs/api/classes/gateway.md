[bpmn-server](../README.md) › [Gateway](gateway.md)
...
\+ **new Gateway**(`id`: any, `process`: any, `type`: any, `def`: any): *[Gateway](gateway.md)*
