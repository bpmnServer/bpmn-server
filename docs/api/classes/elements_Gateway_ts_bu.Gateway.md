[bpmn-server](../README.md) / [Exports](../modules.md) / [elements/Gateway.ts.bu](../modules/elements_Gateway_ts_bu.md) / Gateway

# Class: Gateway

[elements/Gateway.ts.bu](../modules/elements_Gateway_ts_bu.md).Gateway
...
- [constructor](elements_Gateway_ts_bu.Gateway.md#constructor)

### Properties

- [assignee](elements_Gateway_ts_bu.Gateway.md#assignee)
- [attachedTo](elements_Gateway_ts_bu.Gateway.md#attachedto)
- [attachments](elements_Gateway_ts_bu.Gateway.md#attachments)
- [behaviours](elements_Gateway_ts_bu.Gateway.md#behaviours)
- [candidateGroups](elements_Gateway_ts_bu.Gateway.md#candidategroups)
- [candidateUsers](elements_Gateway_ts_bu.Gateway.md#candidateusers)
- [def](elements_Gateway_ts_bu.Gateway.md#def)
- [id](elements_Gateway_ts_bu.Gateway.md#id)
- [inbounds](elements_Gateway_ts_bu.Gateway.md#inbounds)
- [initiator](elements_Gateway_ts_bu.Gateway.md#initiator)
- [isFlow](elements_Gateway_ts_bu.Gateway.md#isflow)
- [lane](elements_Gateway_ts_bu.Gateway.md#lane)
- [messageId](elements_Gateway_ts_bu.Gateway.md#messageid)
- [name](elements_Gateway_ts_bu.Gateway.md#name)
- [outbounds](elements_Gateway_ts_bu.Gateway.md#outbounds)
- [process](elements_Gateway_ts_bu.Gateway.md#process)
- [scripts](elements_Gateway_ts_bu.Gateway.md#scripts)
- [signalId](elements_Gateway_ts_bu.Gateway.md#signalid)
- [subType](elements_Gateway_ts_bu.Gateway.md#subtype)
- [type](elements_Gateway_ts_bu.Gateway.md#type)

### Accessors

- [canBeInvoked](elements_Gateway_ts_bu.Gateway.md#canbeinvoked)
- [isCatching](elements_Gateway_ts_bu.Gateway.md#iscatching)
- [processId](elements_Gateway_ts_bu.Gateway.md#processid)
- [requiresWait](elements_Gateway_ts_bu.Gateway.md#requireswait)

### Methods

- [addBehaviour](elements_Gateway_ts_bu.Gateway.md#addbehaviour)
- [analyzeConvergeFlows](elements_Gateway_ts_bu.Gateway.md#analyzeconvergeflows)
- [cancelBoundaryEvents](elements_Gateway_ts_bu.Gateway.md#cancelboundaryevents)
- [cancelEBG](elements_Gateway_ts_bu.Gateway.md#cancelebg)
- [continue](elements_Gateway_ts_bu.Gateway.md#continue)
- [converge](elements_Gateway_ts_bu.Gateway.md#converge)
- [describe](elements_Gateway_ts_bu.Gateway.md#describe)
- [doEvent](elements_Gateway_ts_bu.Gateway.md#doevent)
- [end](elements_Gateway_ts_bu.Gateway.md#end)
- [enter](elements_Gateway_ts_bu.Gateway.md#enter)
- [execute](elements_Gateway_ts_bu.Gateway.md#execute)
- [findActiveFlows](elements_Gateway_ts_bu.Gateway.md#findactiveflows)
- [getBehaviour](elements_Gateway_ts_bu.Gateway.md#getbehaviour)
- [getInput](elements_Gateway_ts_bu.Gateway.md#getinput)
- [getOutbounds](elements_Gateway_ts_bu.Gateway.md#getoutbounds)
- [getOutput](elements_Gateway_ts_bu.Gateway.md#getoutput)
- [hasBehaviour](elements_Gateway_ts_bu.Gateway.md#hasbehaviour)
- [init](elements_Gateway_ts_bu.Gateway.md#init)
- [restored](elements_Gateway_ts_bu.Gateway.md#restored)
- [resume](elements_Gateway_ts_bu.Gateway.md#resume)
- [run](elements_Gateway_ts_bu.Gateway.md#run)
- [setInput](elements_Gateway_ts_bu.Gateway.md#setinput)
- [start](elements_Gateway_ts_bu.Gateway.md#start)
- [startBoundaryEvents](elements_Gateway_ts_bu.Gateway.md#startboundaryevents)
- [validate](elements_Gateway_ts_bu.Gateway.md#validate)

## Constructors

### constructor

• **new Gateway**(`id`, `process`, `type`, `def`): [`Gateway`](elements_Gateway_ts_bu.Gateway.md)
