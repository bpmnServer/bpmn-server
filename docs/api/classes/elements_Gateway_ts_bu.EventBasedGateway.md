[bpmn-server](../README.md) / [Exports](../modules.md) / [elements/Gateway.ts.bu](../modules/elements_Gateway_ts_bu.md) / EventBasedGateway
...
- [canBeInvoked](elements_Gateway_ts_bu.EventBasedGateway.md#canbeinvoked)
