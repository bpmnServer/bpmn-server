[bpmn-server](../README.md) › [UserTask](usertask.md)
...
\+ **new UserTask**(`id`: any, `process`: any, `type`: any, `def`: any): *[UserTask](usertask.md)*
...
Defined in bpmnServer/src/elements/Tasks.ts:109
...
Defined in bpmnServer/src/elements/Tasks.ts:108
