[bpmn-server](../README.md) › [ServiceTask](servicetask.md)
...
\+ **new ServiceTask**(`id`: any, `process`: any, `type`: any, `def`: any): *[ServiceTask](servicetask.md)*
...
**Returns:** *[ServiceTask](servicetask.md)*
...
Defined in bpmnServer/src/elements/Tasks.ts:34
