[bpmn-server](../README.md) / [Exports](../modules.md) / [elements/Tasks](../modules/elements_Tasks.md) / CallActivity

# Class: CallActivity

[elements/Tasks](../modules/elements_Tasks.md).CallActivity
...
- [constructor](elements_Tasks.CallActivity.md#constructor)

### Properties

- [assignee](elements_Tasks.CallActivity.md#assignee)
- [attachedTo](elements_Tasks.CallActivity.md#attachedto)
- [attachments](elements_Tasks.CallActivity.md#attachments)
- [behaviours](elements_Tasks.CallActivity.md#behaviours)
- [candidateGroups](elements_Tasks.CallActivity.md#candidategroups)
- [candidateUsers](elements_Tasks.CallActivity.md#candidateusers)
- [def](elements_Tasks.CallActivity.md#def)
- [id](elements_Tasks.CallActivity.md#id)
- [inbounds](elements_Tasks.CallActivity.md#inbounds)
- [initiator](elements_Tasks.CallActivity.md#initiator)
- [isFlow](elements_Tasks.CallActivity.md#isflow)
- [lane](elements_Tasks.CallActivity.md#lane)
- [messageId](elements_Tasks.CallActivity.md#messageid)
- [name](elements_Tasks.CallActivity.md#name)
- [outbounds](elements_Tasks.CallActivity.md#outbounds)
- [process](elements_Tasks.CallActivity.md#process)
- [scripts](elements_Tasks.CallActivity.md#scripts)
- [signalId](elements_Tasks.CallActivity.md#signalid)
- [subType](elements_Tasks.CallActivity.md#subtype)
- [type](elements_Tasks.CallActivity.md#type)

### Accessors

- [calledElement](elements_Tasks.CallActivity.md#calledelement)
- [canBeInvoked](elements_Tasks.CallActivity.md#canbeinvoked)
- [isCatching](elements_Tasks.CallActivity.md#iscatching)
- [processId](elements_Tasks.CallActivity.md#processid)
- [requiresWait](elements_Tasks.CallActivity.md#requireswait)

### Methods

- [addBehaviour](elements_Tasks.CallActivity.md#addbehaviour)
- [cancelBoundaryEvents](elements_Tasks.CallActivity.md#cancelboundaryevents)
- [cancelEBG](elements_Tasks.CallActivity.md#cancelebg)
- [continue](elements_Tasks.CallActivity.md#continue)
- [describe](elements_Tasks.CallActivity.md#describe)
- [doEvent](elements_Tasks.CallActivity.md#doevent)
- [end](elements_Tasks.CallActivity.md#end)
- [enter](elements_Tasks.CallActivity.md#enter)
- [execute](elements_Tasks.CallActivity.md#execute)
- [getBehaviour](elements_Tasks.CallActivity.md#getbehaviour)
- [getInput](elements_Tasks.CallActivity.md#getinput)
- [getOutbounds](elements_Tasks.CallActivity.md#getoutbounds)
- [getOutput](elements_Tasks.CallActivity.md#getoutput)
- [hasBehaviour](elements_Tasks.CallActivity.md#hasbehaviour)
- [init](elements_Tasks.CallActivity.md#init)
- [restored](elements_Tasks.CallActivity.md#restored)
- [resume](elements_Tasks.CallActivity.md#resume)
- [run](elements_Tasks.CallActivity.md#run)
- [setInput](elements_Tasks.CallActivity.md#setinput)
- [start](elements_Tasks.CallActivity.md#start)
- [startBoundaryEvents](elements_Tasks.CallActivity.md#startboundaryevents)
- [validate](elements_Tasks.CallActivity.md#validate)
- [executionEnded](elements_Tasks.CallActivity.md#executionended)

## Constructors

### constructor

• **new CallActivity**(`id`, `process`, `type`, `def`): [`CallActivity`](elements_Tasks.CallActivity.md)
...
[src/elements/Tasks.ts:273](https://github.com/linonetwo/bpmn-server/blob/02da6f2/src/elements/Tasks.ts#L273)
...
[src/elements/Tasks.ts:278](https://github.com/linonetwo/bpmn-server/blob/02da6f2/src/elements/Tasks.ts#L278)
...
[src/elements/Tasks.ts:277](https://github.com/linonetwo/bpmn-server/blob/02da6f2/src/elements/Tasks.ts#L277)
...
[src/elements/Tasks.ts:286](https://github.com/linonetwo/bpmn-server/blob/02da6f2/src/elements/Tasks.ts#L286)
...
[src/elements/Tasks.ts:280](https://github.com/linonetwo/bpmn-server/blob/02da6f2/src/elements/Tasks.ts#L280)
