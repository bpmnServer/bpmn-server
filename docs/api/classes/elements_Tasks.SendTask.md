[bpmn-server](../README.md) / [Exports](../modules.md) / [elements/Tasks](../modules/elements_Tasks.md) / SendTask

# Class: SendTask

[elements/Tasks](../modules/elements_Tasks.md).SendTask
...
- [constructor](elements_Tasks.SendTask.md#constructor)

### Properties

- [assignee](elements_Tasks.SendTask.md#assignee)
- [attachedTo](elements_Tasks.SendTask.md#attachedto)
- [attachments](elements_Tasks.SendTask.md#attachments)
- [behaviours](elements_Tasks.SendTask.md#behaviours)
- [candidateGroups](elements_Tasks.SendTask.md#candidategroups)
- [candidateUsers](elements_Tasks.SendTask.md#candidateusers)
- [def](elements_Tasks.SendTask.md#def)
- [id](elements_Tasks.SendTask.md#id)
- [inbounds](elements_Tasks.SendTask.md#inbounds)
- [initiator](elements_Tasks.SendTask.md#initiator)
- [isFlow](elements_Tasks.SendTask.md#isflow)
- [lane](elements_Tasks.SendTask.md#lane)
- [messageId](elements_Tasks.SendTask.md#messageid)
- [name](elements_Tasks.SendTask.md#name)
- [outbounds](elements_Tasks.SendTask.md#outbounds)
- [process](elements_Tasks.SendTask.md#process)
- [scripts](elements_Tasks.SendTask.md#scripts)
- [signalId](elements_Tasks.SendTask.md#signalid)
- [subType](elements_Tasks.SendTask.md#subtype)
- [type](elements_Tasks.SendTask.md#type)

### Accessors

- [canBeInvoked](elements_Tasks.SendTask.md#canbeinvoked)
- [isCatching](elements_Tasks.SendTask.md#iscatching)
- [processId](elements_Tasks.SendTask.md#processid)
- [requiresWait](elements_Tasks.SendTask.md#requireswait)
- [serviceName](elements_Tasks.SendTask.md#servicename)

### Methods

- [addBehaviour](elements_Tasks.SendTask.md#addbehaviour)
- [cancelBoundaryEvents](elements_Tasks.SendTask.md#cancelboundaryevents)
- [cancelEBG](elements_Tasks.SendTask.md#cancelebg)
- [continue](elements_Tasks.SendTask.md#continue)
- [describe](elements_Tasks.SendTask.md#describe)
- [doEvent](elements_Tasks.SendTask.md#doevent)
- [end](elements_Tasks.SendTask.md#end)
- [enter](elements_Tasks.SendTask.md#enter)
- [execute](elements_Tasks.SendTask.md#execute)
- [getBehaviour](elements_Tasks.SendTask.md#getbehaviour)
- [getInput](elements_Tasks.SendTask.md#getinput)
- [getOutbounds](elements_Tasks.SendTask.md#getoutbounds)
- [getOutput](elements_Tasks.SendTask.md#getoutput)
- [hasBehaviour](elements_Tasks.SendTask.md#hasbehaviour)
- [init](elements_Tasks.SendTask.md#init)
- [restored](elements_Tasks.SendTask.md#restored)
- [resume](elements_Tasks.SendTask.md#resume)
- [run](elements_Tasks.SendTask.md#run)
- [setInput](elements_Tasks.SendTask.md#setinput)
- [start](elements_Tasks.SendTask.md#start)
- [startBoundaryEvents](elements_Tasks.SendTask.md#startboundaryevents)
- [validate](elements_Tasks.SendTask.md#validate)

## Constructors

### constructor

• **new SendTask**(`id`, `process`, `type`, `def`): [`SendTask`](elements_Tasks.SendTask.md)
...
[src/elements/Tasks.ts:134](https://github.com/linonetwo/bpmn-server/blob/02da6f2/src/elements/Tasks.ts#L134)
