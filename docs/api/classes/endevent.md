...
\+ **new EndEvent**(`id`: any, `process`: any, `type`: any, `def`: any): *[EndEvent](endevent.md)*
...
Defined in bpmnServer/src/elements/Events.ts:84
...
Defined in bpmnServer/src/elements/Events.ts:85
