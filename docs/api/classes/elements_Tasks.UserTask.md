[bpmn-server](../README.md) / [Exports](../modules.md) / [elements/Tasks](../modules/elements_Tasks.md) / UserTask

# Class: UserTask

[elements/Tasks](../modules/elements_Tasks.md).UserTask
...
- [constructor](elements_Tasks.UserTask.md#constructor)

### Properties

- [assignee](elements_Tasks.UserTask.md#assignee)
- [attachedTo](elements_Tasks.UserTask.md#attachedto)
- [attachments](elements_Tasks.UserTask.md#attachments)
- [behaviours](elements_Tasks.UserTask.md#behaviours)
- [candidateGroups](elements_Tasks.UserTask.md#candidategroups)
- [candidateUsers](elements_Tasks.UserTask.md#candidateusers)
- [def](elements_Tasks.UserTask.md#def)
- [id](elements_Tasks.UserTask.md#id)
- [inbounds](elements_Tasks.UserTask.md#inbounds)
- [initiator](elements_Tasks.UserTask.md#initiator)
- [isFlow](elements_Tasks.UserTask.md#isflow)
- [lane](elements_Tasks.UserTask.md#lane)
- [messageId](elements_Tasks.UserTask.md#messageid)
- [name](elements_Tasks.UserTask.md#name)
- [outbounds](elements_Tasks.UserTask.md#outbounds)
- [process](elements_Tasks.UserTask.md#process)
- [scripts](elements_Tasks.UserTask.md#scripts)
- [signalId](elements_Tasks.UserTask.md#signalid)
- [subType](elements_Tasks.UserTask.md#subtype)
- [type](elements_Tasks.UserTask.md#type)

### Accessors

- [canBeInvoked](elements_Tasks.UserTask.md#canbeinvoked)
- [isCatching](elements_Tasks.UserTask.md#iscatching)
- [processId](elements_Tasks.UserTask.md#processid)
- [requiresWait](elements_Tasks.UserTask.md#requireswait)

### Methods

- [addBehaviour](elements_Tasks.UserTask.md#addbehaviour)
- [cancelBoundaryEvents](elements_Tasks.UserTask.md#cancelboundaryevents)
- [cancelEBG](elements_Tasks.UserTask.md#cancelebg)
- [continue](elements_Tasks.UserTask.md#continue)
- [describe](elements_Tasks.UserTask.md#describe)
- [doEvent](elements_Tasks.UserTask.md#doevent)
- [end](elements_Tasks.UserTask.md#end)
- [enter](elements_Tasks.UserTask.md#enter)
- [execute](elements_Tasks.UserTask.md#execute)
- [getBehaviour](elements_Tasks.UserTask.md#getbehaviour)
- [getInput](elements_Tasks.UserTask.md#getinput)
- [getOutbounds](elements_Tasks.UserTask.md#getoutbounds)
- [getOutput](elements_Tasks.UserTask.md#getoutput)
- [hasBehaviour](elements_Tasks.UserTask.md#hasbehaviour)
- [init](elements_Tasks.UserTask.md#init)
- [restored](elements_Tasks.UserTask.md#restored)
- [resume](elements_Tasks.UserTask.md#resume)
- [run](elements_Tasks.UserTask.md#run)
- [setAssignVal](elements_Tasks.UserTask.md#setassignval)
- [setInput](elements_Tasks.UserTask.md#setinput)
- [start](elements_Tasks.UserTask.md#start)
- [startBoundaryEvents](elements_Tasks.UserTask.md#startboundaryevents)
- [validate](elements_Tasks.UserTask.md#validate)

## Constructors

### constructor

• **new UserTask**(`id`, `process`, `type`, `def`): [`UserTask`](elements_Tasks.UserTask.md)
...
[src/elements/Tasks.ts:213](https://github.com/linonetwo/bpmn-server/blob/02da6f2/src/elements/Tasks.ts#L213)
...
[src/elements/Tasks.ts:212](https://github.com/linonetwo/bpmn-server/blob/02da6f2/src/elements/Tasks.ts#L212)
...
[src/elements/Tasks.ts:201](https://github.com/linonetwo/bpmn-server/blob/02da6f2/src/elements/Tasks.ts#L201)
...
[src/elements/Tasks.ts:148](https://github.com/linonetwo/bpmn-server/blob/02da6f2/src/elements/Tasks.ts#L148)
...
[src/elements/Tasks.ts:173](https://github.com/linonetwo/bpmn-server/blob/02da6f2/src/elements/Tasks.ts#L173)
...
[src/elements/Tasks.ts:152](https://github.com/linonetwo/bpmn-server/blob/02da6f2/src/elements/Tasks.ts#L152)
